...
- [x] **SCHM-01**: Cartridge model extended with 5 optional drawing fields (shoulder_angle_deg, neck_length_mm, body_length_mm, rim_thickness_mm, case_type)
- [x] **SCHM-02**: Bullet model extended with 4 optional rendering fields (bearing_surface_mm, boat_tail_length_mm, meplat_diameter_mm, ogive_type)
- [x] **SCHM-03**: Geometry engine estimates missing dimensions from existing data with documented heuristics

### 2D SVG Drawings

- [x] **VIS2-01**: User can view cartridge cross-section SVG with labeled dimensions from DB data
- [x] **VIS2-02**: User can view cartridge-in-chamber drawing showing headspace, freebore, and rifling engagement
- [x] **VIS2-03**: User can view full assembly drawing with barrel and OBT harmonic node positions overlaid
...
| VIS2-01 | Phase 12 | Complete |
| VIS2-02 | Phase 12 | Complete |
| VIS2-03 | Phase 12 | Complete |
